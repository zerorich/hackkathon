...
def autowire_from_packages() -> None:
    ...
    try:
        from app.agents.orchestrator import Orchestrator  # type: ignore[import-not-found]
    ...
    service_modules = {
        ...
        "classes": "app.services.classes",
        "subjects": "app.services.subjects",
        "topics": "app.services.topics",
        "challenges": "app.services.challenges",
        "attempts": "app.services.attempts",
        "duels": "app.services.duels",
        "student": "app.services.student",
        "leaderboard": "app.services.leaderboard",
        "teacher": "app.services.teacher",
