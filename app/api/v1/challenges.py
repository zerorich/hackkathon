...
from app.api.mappers import challenge_detail_to_out, challenge_to_out
from app.api.schemas import ChallengeGenerateBody, ChallengeStatusUpdateBody
...
from app.models.entities import AiGenerationJob, Challenge, Question, Subject, Topic, User
