...
- Client: `app.ai.client.AgentRouterClient`

## Agent ownership

| Path | Owner |
|------|-------|
| `app/core/`, `app/ai/`, `pyproject.toml`, `.env.example` | Agent 1 (bootstrap) |
| `app/db/`, `app/models/` | Agent 2 |
| `app/api/`, auth middleware | Agent 3 |
| `app/services/`, calculations | Agent 4 |
| `app/agents/`, workers, seed | Agent 5 |
| `tests/` | shared |
