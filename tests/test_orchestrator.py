...
from app.models.entities import AiGenerationJob, Challenge, Subject, Topic, User
from app.services.orchestrator import AI_PROVIDER_NAME, AiOrchestrator
...
async def test_orchestrator_respects_concurrency_limit():
    ...
    with patch.object(orchestrator, "_process_job", side_effect=slow_process):
        ...
        async with factory() as session:
            ...
            from app.models.entities import ClassMembership, SchoolClass
...
async def test_orchestrator_processes_job_with_mocked_ai():
    ...
    async with factory() as session:
        ...
        session.add(user)
        await session.flush()
        from app.models.entities import SchoolClass
